...
def display_result_single(args):
    if args.input_file is None:
        input_file = (
            f"./results-pandagpt/1image{args.bench_name}/model_judgment/{args.judge_model}_single.jsonl"
        )
    else:
...
if __name__ == "__main__":
    ...
    if args.input_file is None:
        args.input_file = (
            f"./results/{args.bench_name}/model_judgment/{args.judge_model}_{args.mode}.jsonl"
        )
