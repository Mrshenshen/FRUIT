...
def get_model(model_name, device=None):
    ...
    if model_name == 'blip2-7b':
        from .test_blip2 import TestBlip2
        return TestBlip2(name='blip2_opt', model_type='pretrain_opt6.7b', config_path='path to blip2_pretrain_opt6.7b.yaml', device=device) 
    elif model_name == 'blip2-13b':
        from .test_blip2 import TestBlip2
        return TestBlip2(name='blip2_t5', model_type='pretrain_flant5xxl', config_path='path to blip2_pretrain_flant5xxl.yaml', device=device)
    elif model_name == 'caption':
        from .caption import TestLLaVA2
        return TestLLaVA2(size='1.5-7b', device=device)        
    elif model_name == 'minigpt4':
        # from .test_minigpt4 import TestMiniGPT4
        from .test_minigpt4_caption import TestMiniGPT4
        return TestMiniGPT4(device=device)
    elif model_name == 'minigpt4-13b':
        # from .test_minigpt4_1 import TestMiniGPT4
        from .test_minigpt4_1_caption import TestMiniGPT4
        return TestMiniGPT4(device=device)
    elif model_name == 'mPLUG-Owl'.lower():
        # from .test_mplug_owl import TestMplugOwl
        from .test_mplug_owl_caption import TestMplugOwl
        return TestMplugOwl(device)
    elif model_name == 'Otter-Image'.lower():
        from .test_otter_image_caption import TestOtterImage
        ...
        from .test_blip2_caption import TestBlip2
        # from .test_blip2 import TestBlip2
        return TestBlip2(device=device, config_path='path to blip2_instruct_vicuna7b.yaml', name='blip2_vicuna_instruct', model_type='vicuna7b')
    elif model_name == 'InstructBLIP-13b-flant5'.lower():
        from .test_blip2 import TestBlip2
        return TestBlip2(device=device, config_path='path to blip2_instruct_flant5xxl.yaml', name='blip2_t5_instruct', model_type='flant5xxl')
        ...
        # from .test_llava2 import TestLLaVA2
        from .test_llava_caption import TestLLaVA2
        return TestLLaVA2(size='1.5-7b', device=device)
        ...
        from .test_pandagpt_caption import TestPandaGPT
