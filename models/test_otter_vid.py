...
task_type ='normal'
# if task_type == 'ns':
#     filename = "/data/nvme1/huangzhiyi/EgoTV/ns.json" # 700
# elif task_type == 'nt':
#     filename = "/data/nvme1/huangzhiyi/EgoTV/nt.json" # 1080
# elif task_type == 'nsc':
#     filename = "/data/nvme1/huangzhiyi/EgoTV/nsc.json" # 2164
# elif task_type == 'abs':
#     filename = "/data/nvme1/huangzhiyi/EgoTV/abs.json" # 676



#CSV    
log_file = open("./hzy_res/log_hzy_test_csv.txt", "w")
for task_type in['no','ns','nt']:
    if task_type == 'no':
        filename = "./egotv/csv/novel_operators.json" # 960
    elif task_type == 'ns':
        filename = "./egotv/csv/novel_steps.json" # 896
    elif task_type == 'nt':
        filename = "./egotv/csv/novel_tasks.json" # 3360
